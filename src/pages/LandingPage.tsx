      ...
      <header className="container mx-auto px-4 py-8">
        <nav className="flex items-center justify-between mb-16">
          ...
          <div className="flex gap-4">
            ...
            <Link to="/signin-clinician">
              <Button className="bg-gradient-primary">Clinician Login</Button>
            </Link>
        ...
        <div className="text-center max-w-4xl mx-auto mb-20 animate-slide-up">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Empowering patients and clinicians with AI-driven real-time fever
            tracking, predictive analytics, and automated follow-ups—improving
            outcomes and easing healthcare burdens.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="p-6 hover-lift animate-scale-in border-2 border-border">
            ...
            <p className="text-muted-foreground">
              Seamless IoT thermometer integration with continuous temperature
              tracking and automated data sync.
            </p>
          </Card>

          <Card
            className="p-6 hover-lift animate-scale-in border-2 border-border"
          ...
          >
            ...
            <p className="text-muted-foreground">
              LSTM models analyze fever trends and predict risk patterns for
              timely intervention.
            </p>
          </Card>
          ...
          >
            ...
            <p className="text-muted-foreground">
              BERT-powered conversational AI conducts symptom checks in English,
              Hindi, and Kannada.
            </p>
          </Card>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Automated notifications for persistent fevers with priority-based
              escalation to clinicians.
            </p>
          </Card>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Comprehensive patient analytics, outbreak heatmaps, and risk
          ...
          >
            ...
            <p className="text-muted-foreground">
              Advanced forecasting for public health surveillance and outbreak
              detection.
            </p>
          </Card>
        </div>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <Card className="p-12 max-w-3xl mx-auto border-2 border-primary/20 animate-glow">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Transform Fever Care?
          </h2>
          <p className="text-muted-foreground mb-8">
            Join healthcare providers using FieveAI to improve patient outcomes
            and reduce hospital burdens.
          </p>
          <div className="flex gap-4 justify-center">
            <Link to="/patient">
